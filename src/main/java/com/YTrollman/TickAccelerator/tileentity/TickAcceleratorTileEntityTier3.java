...
public class TickAcceleratorTileEntityTier3 extends TileEntity implements ITickableTileEntity {

    protected boolean isPoweredByRedstone;

    public TickAcceleratorTileEntityTier3() {
        super(ModTileEntityTypes.TICK_ACCELERATOR_BLOCK_TIER_3_TILE_ENTITY.get());
    }
    ...
    public void accelerateTick(World world, BlockPos pos) {
        ...
        if(!world.isClientSide && world instanceof ServerWorld){
            if (block.isRandomlyTicking(blockState) && world.getRandom().nextInt(20) == 0) {
