...
public class TickAcceleratorBlockTier3 extends Block {

    public TickAcceleratorBlockTier3(Properties properties) {
        super(properties);
    }
    ...
    public void neighborChanged(BlockState state, World world, BlockPos pos, Block changedBlock, BlockPos changedBlockPos, boolean bool) {
        ...
        if (tileEntity instanceof TickAcceleratorTileEntityTier3) {
            TickAcceleratorTileEntityTier3 TileEntity = (TickAcceleratorTileEntityTier3) tileEntity;
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new TickAcceleratorTileEntityTier3();
    }
}
